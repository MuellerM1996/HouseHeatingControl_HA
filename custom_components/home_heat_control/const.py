...
HHCSENSOR_TYPES = [
    ...
    [0, SensorEntityDescription(name="Pufferspeicher Ladeventilventilstatus" , key="bufferstorage_chargevalvestatus", device_class=SensorDeviceClass.ENUM)],
    [0, SensorEntityDescription(name="Pufferspeicher Ladestatus" , key="bufferstorage_chargestatus", device_class=SensorDeviceClass.ENUM)],
    [1, BinarySensorEntityDescription(name="Pufferspeicher nur E-Laden", key="bufferstorage_chargeElectricOnly")],
    #WarmWater
    ...
    [1, BinarySensorEntityDescription(name="Warmwasser Boiler manuelles laden", key="warmwater_boiler_manualChargeActive")],
    [1, BinarySensorEntityDescription(name="Warmwasser Bad heizen aktiv", key="warmwater_bath_heatingactive")],
    [0, SensorEntityDescription(name="Warmwasser Zirkulation Abgabetemperatur", key="warmwater_circulation_outputtemerature", state_class=SensorStateClass.MEASUREMENT, device_class=SensorDeviceClass.TEMPERATURE, unit_of_measurement=UnitOfTemperature.CELSIUS)],
    [0, SensorEntityDescription(name="Warmwasser Zirkulation Pumpenstatus" , key="warmwater_circulation_pumpstatus", device_class=SensorDeviceClass.ENUM)],
    [0, SensorEntityDescription(name="Warmwasser Zirkulation Kreis 1 Status" , key="warmwater_circulation_circuit1_status", device_class=SensorDeviceClass.ENUM)],
    [0, SensorEntityDescription(name="Warmwasser Zirkulation Kreis 1 Temperatur", key="warmwater_circulation_circuit1_temperature", state_class=SensorStateClass.MEASUREMENT, device_class=SensorDeviceClass.TEMPERATURE, unit_of_measurement=UnitOfTemperature.CELSIUS)],
    [0, SensorEntityDescription(name="Warmwasser Zirkulation Kreis 1 Ventilstatus" , key="warmwater_circulation_circuit1_valvestatus", device_class=SensorDeviceClass.ENUM)],
    [0, SensorEntityDescription(name="Warmwasser Zirkulation Kreis 2 Status" , key="warmwater_circulation_circuit2_status", device_class=SensorDeviceClass.ENUM)],
    [0, SensorEntityDescription(name="Warmwasser Zirkulation Kreis 2 Temperatur", key="warmwater_circulation_circuit2_temperature", state_class=SensorStateClass.MEASUREMENT, device_class=SensorDeviceClass.TEMPERATURE, unit_of_measurement=UnitOfTemperature.CELSIUS)],
    [0, SensorEntityDescription(name="Warmwasser Zirkulation Kreis 2 Ventilstatus" , key="warmwater_circulation_circuit2_valvestatus", device_class=SensorDeviceClass.ENUM)],
    #Woodburner
    ...
    #Gasburner
    [0, SensorEntityDescription(name="Gasbrenner Status" , key="gasburner_status", device_class=SensorDeviceClass.ENUM)],
    [0, SensorEntityDescription(name="Gasbrenner Abgastemperatur", key="gasburner_exhaust_temerature", state_class=SensorStateClass.MEASUREMENT, device_class=SensorDeviceClass.TEMPERATURE, unit_of_measurement=UnitOfTemperature.CELSIUS)],
    [0, SensorEntityDescription(name="Gasbrenner Wassertemperatur", key="gasburner_water_temerature", state_class=SensorStateClass.MEASUREMENT, device_class=SensorDeviceClass.TEMPERATURE, unit_of_measurement=UnitOfTemperature.CELSIUS)],
]