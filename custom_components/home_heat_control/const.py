...
HHCSENSOR_TYPES = [
    ...
    [1, SensorEntityDescription(name="DTCs Aktiv", key="dtcactive", device_class=BinarySensorDeviceClass.PROBLEM)],
    ...
    [1, SensorEntityDescription(name="Hauptschalter", key="heatcontrolmanagement_enabled")],
]